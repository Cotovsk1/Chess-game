...
# Автоматично створюємо папки для збереження аватарок, якщо їх ще немає
...
# Для розробки дозволяємо всі origins
